...
class PackagexProjectExample {
  ...
  static Map get default_data {
    return {"name": "example", "description": "A new Flutter project.", "publish_to": "none", "version": "1.0.0+1", "obfuscate": true, "split-debug-info": "0.0.5", "build-name": "0.0.5", "build-number": 40, "split-per-abi": true, "no-tree-shake-icons": true};
  }
}
